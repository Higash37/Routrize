...
export function RouteDetailPage({ items, title }: RouteDetailPageProps) {
  ...
  function renderCard(item: RouteItemState) {
    return (
      <div key={item.id} className="rounded-lg border p-3 text-xs break-inside-avoid mb-3">
    ...
    <div className="hidden print:block break-before-page p-6">
      <div className="flex gap-3">
        <div className="flex-1">
          <h2 className="text-lg font-bold mb-3">{title} — 教材詳細</h2>
